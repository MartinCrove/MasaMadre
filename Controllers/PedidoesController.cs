...
namespace MASAMADREPROY.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,FechaPedido,FechaEntrega,CostoTotal,Estado")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,FechaPedido,FechaEntrega,CostoTotal,Estado")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
